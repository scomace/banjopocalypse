...
const SHARED: BarkPool = {
  ...
  hazard: [
    ...
    "Somethin' in the air today, and it ain't good.",
    "Oh, we're doin' it like THAT?",
    "Lord give me strength and a mop.",
    "I've seen worse. Not lately.",
    "Whoever's in charge up there is drunk.",
    "That's a new one on me.",
    "Reckon we roll with it.",
    "Well, nobody said it'd be tidy.",
    "This is fine. This is absolutely fine.",
    "Hold my jug. HOLD IT.",
    "Weather's got opinions again.",
  ],
  levelIntro: [
