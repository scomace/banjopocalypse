...
// Granny Mae's root cellar: stone lintel, plank hatch with gaps, iron straps. Frame 1: planks kicked loose.
const SPR_CAGE_GRANNY: PixelSprite = {
  palette: {
    k: INK,
    s: "#8d8a80",
    S: "#b5b2a6",
  ...
  frames: [
    [
      ...
      ".kssssssssssssssssssssssk.",
      ".kdbbld..ld..ld..ld..bbdk.",
      ".kdbbld..ld..ld..ld..bbdk.",
      ".kdbbld..ld..ld..ld..bbdk.",
      ".kdbbld..ld..ld..ld..bbdk.",
      ".kdbbld..ld..ld..ld..bbdk.",
      ".kdbbld..ld..ld..ld..bbdk.",
      ".kdbbiiiiiiiiiiiiiiiibbdk.",
      ".kdbbIIIIIIIIIIIIIIIIbbdk.",
      ".kdbbld..ld..ld..ld..bbdk.",
      ".kdbbld..ld..ld..ld..bbdk.",
      ".kdbbld..ld..ld..ld..bbdk.",
...
// Bobbie Sue's sporting-goods lockup: steel posts, diamond mesh, red sign plate. Frame 1: a door-sized panel torn out.
const SPR_CAGE_BOBBIESUE: PixelSprite = {
  palette: {
    k: INK,
    i: "#6a7078",
    h: "#9aa2aa",
  ...
  frames: [
    [
      ...
      ".khim...m...m...m...m.hik.",
      ".khi.m.mRRRRRRRRRR.m.mhik.",
      ".khi..m.RrrrrrrrrRm...hik.",
      ".khi.m.mRrwrwrwrwR.m.mhik.",
      ".khim...RrrrrrrrrR..m.hik.",
      ".khi.m.mRRRRRRRRRR.m.mhik.",
      ".khi..m...m...m...m...hik.",
      ".khi.m.m.m.m.m.m.m.m.mhik.",
      ".khim...m...m...m...m.hik.",
      ".khi.m.m.m.m.m.m.m.m.mhik.",
      ".khi..m...m...m...m...hik.",
      ".khi.m.m.m.m.m.m.m.m.mhik.",
    ...
    [
      ...
      ".khi.m.mRRRRRRRRRR.m.mhik.",
      ".khi..m.RrrrrrrrrRm...hik.",
      ".khi.m.mRrwrwrwrwRhhhhhik.",
      ".khim...RrrrrrrrrR....hik.",
      ".khi.m.mRRRRRRRRRR....hik.",
      ".khi..m...m...........hik.",
      ".khi.m.m.m.mh.........hik.",
      ".khim...m..m..........hik.",
      ".khi.m.m.m.m..........hik.",
...
// Cooter's propane tank (back layer, behind him): white cylinder, rust, valve. Frame 1: a lick of flame off the valve.
const SPR_CAGE_COOTER_BACK: PixelSprite = {
  palette: {
    k: INK,
    w: "#fff6d8",
    v: "#c9cdc4",
...
// Cooter's chains (front layer): two chains in an X, stapled down. Frame 1: heaped at his boots.
const SPR_CAGE_COOTER: PixelSprite = {
  palette: {
    k: INK,
    c: "#8a9098",
    C: "#4a5058",
  ...
  frames: [
    ...
    [
      ...
      "......k.k.k.k.k.k.k.......",
      "...k.kCkCkCkCkCkCkCk.k....",
      "..kckkCkkckkCkkckkCkkck...",
      "kkkkCc.cC.Cc.cC.Cc.cC.Ckkk",
      "iiiiiiiiiiiiiiiiiiiiiiiiii",
      "vvvvvvvvvvvvvvvvvvvvvvvvvv",
    ],
  ],
...
// Darlene's sideshow curtain (back layer): red velvet, folds.
const SPR_CAGE_DARLENE_BACK: PixelSprite = {
  palette: {
    k: INK,
    r: "#c0302a",
    R: "#7a1d18",
...
// Darlene's gilded sideshow cage (front layer): gold bars, dome + finial, marquee with bulbs. Frame 1: door swung, every bulb lit.
const SPR_CAGE_DARLENE: PixelSprite = {
  palette: {
    k: INK,
    g: "#e0b030",
    G: "#a07a18",
  ...
  frames: [
    ...
    [
      ...
      "gkkGg...........gG...gk...",
      "gkkGg...........gG...gk...",
      "gkkGGGGGGGGGGGGGGGGGGGGk..",
      "k.kgggygggygggygggyggggk..",
      "..kGGGGGGGGGGGGGGGGGGGGk..",
    ],
  ],
};

// Buford's bait cage: rusty wire box hung off a rope, bait hooks on the sides. Frame 1: the right flap kicked out.
const SPR_CAGE_BUFORD: PixelSprite = {
  palette: {
    k: INK,
    p: "#b89058",
    P: "#7c5c30",
...
// Zeke's weather tower (back layer): steel lattice, lightning rod. Frame 1: strike seven on the rod.
const SPR_CAGE_ZEKE_BACK: PixelSprite = {
  palette: {
    k: INK,
    i: "#6a7078",
    h: "#9aa2aa",
...
// Zeke's straps (front layer): three cinch straps with buckles. Frame 1: dropped to the deck.
const SPR_CAGE_ZEKE: PixelSprite = {
  palette: {
    k: INK,
    p: "#b89058",
    P: "#7c5c30",
...
// Shared brass padlock, drawn over every rig at CAGE_RIGS[...].lock: whole, cracked, busted.
const SPR_PADLOCK: PixelSprite = {
  palette: {
    k: INK,
    g: "#e0b030",
    G: "#a07a18",
...
/** Which layers draw for each caged cousin, and where the padlock sits
 *  (sprite px from the rig's bottom-center; the renderer scales x2). */
export const CAGE_RIGS: Record<string, { front: string; back?: string; lock: [number, number] }> = {
  granny: { front: "cage_granny", lock: [8, -11] },
  bobbiesue: { front: "cage_bobbiesue", lock: [6, -15] },
  cooter: { front: "cage_cooter", back: "cage_cooter_back", lock: [9, -12] },
  darlene: { front: "cage_darlene", back: "cage_darlene_back", lock: [-5, -15] },
  buford: { front: "cage_buford", lock: [7, -14] },
  zeke: { front: "cage_zeke", back: "cage_zeke_back", lock: [9, -10] },
};
...
export const MISC_ITEM_SPRITES: Record<string, PixelSprite> = {
  ...
  cage_granny: SPR_CAGE_GRANNY,
  cage_bobbiesue: SPR_CAGE_BOBBIESUE,
  cage_cooter: SPR_CAGE_COOTER,
  cage_cooter_back: SPR_CAGE_COOTER_BACK,
  cage_darlene: SPR_CAGE_DARLENE,
  cage_darlene_back: SPR_CAGE_DARLENE_BACK,
  cage_buford: SPR_CAGE_BUFORD,
  cage_zeke: SPR_CAGE_ZEKE,
  cage_zeke_back: SPR_CAGE_ZEKE_BACK,
  padlock: SPR_PADLOCK,
  jar: SPR_JAR,
};
